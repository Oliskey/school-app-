...
const EditTeacherProfileScreen: React.FC = () => {
    ...
    const handleRemoveImage = () => {
        setAvatar('https://i.pravatar.cc/150?u=teacher');
        setImageError(false);
    };
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute bottom-0 right-0 flex space-x-1">
                                <label 
                                    ...
                                    className="bg-purple-600 p-2 rounded-full border-2 border-white cursor-pointer hover:bg-purple-700"
                         ...
                         <div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    type="text" 
                                    id="subject" 
                                    value={mockTeacher.subject} 
                                    disabled 
                                    className="w-full pl-10 pr-3 py-3 text-gray-700 bg-gray-200 border border-gray-300 rounded-lg cursor-not-allowed" 
                                />
                            </div>
                        </div>
                    </div>
