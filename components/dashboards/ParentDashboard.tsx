                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold" style={{color: colorTheme.text}}>Grade {student.grade}{student.section}</p>
                        </div>
                    </div>
        ...
        <div className="flex flex-col h-full bg-gray-50">
            ...
            <div className="p-4 bg-white flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p className="text-gray-700 font-medium">Grade {student.grade}{student.section}</p>
                </div>
            </div>
